...
<template>
  <div>
    <div v-if="notFound" class="rc-page rc-page--wide text-center">
    ...
    <div v-else-if="loadError" class="rc-page rc-page--wide">
      <RcAlert tone="danger">{{ loadError }}</RcAlert>
    </div>

    <div v-else-if="product" class="rc-page rc-page--wide">
